...
with b0RemoteApi.RemoteApiClient('b0RemoteApi_pythonClient','b0RemoteApi',60) as client:    
    ...
    client.simxCallScriptFunction('remoteApi_movementDataFunction@'+targetArm1,'sim.scripttype_childscript',movementData,client.simxDefaultPublisher())
    client.simxCallScriptFunction('remoteApi_movementDataFunction@'+targetArm2,'sim.scripttype_childscript',movementData,client.simxDefaultPublisher())

    # Execute the first movement sequence:
    client.simxCallScriptFunction('remoteApi_executeMovement@'+targetArm1,'sim.scripttype_childscript','movSeq1',client.simxDefaultPublisher())
    client.simxCallScriptFunction('remoteApi_executeMovement@'+targetArm2,'sim.scripttype_childscript','movSeq1',client.simxDefaultPublisher())
    ...
    client.simxCallScriptFunction('remoteApi_executeMovement@'+targetArm1,'sim.scripttype_childscript','movSeq2',client.simxDefaultPublisher())
    client.simxCallScriptFunction('remoteApi_executeMovement@'+targetArm2,'sim.scripttype_childscript','movSeq2',client.simxDefaultPublisher())
    client.simxCallScriptFunction('remoteApi_executeMovement@'+targetArm1,'sim.scripttype_childscript','movSeq3',client.simxDefaultPublisher())
    client.simxCallScriptFunction('remoteApi_executeMovement@'+targetArm2,'sim.scripttype_childscript','movSeq3',client.simxDefaultPublisher())
