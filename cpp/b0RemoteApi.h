...
public:
    ...
    std::vector<msgpack::object>* simxSetVisionSensorImage(int objectHandle,bool greyScale,const char* img,size_t imgSize,const char* topic);

    std::vector<msgpack::object>* simxAuxiliaryConsoleClose(int consoleHandle,const char* topic);
    std::vector<msgpack::object>* simxAuxiliaryConsolePrint(int consoleHandle,const char* text,const char* topic);
    std::vector<msgpack::object>* simxAuxiliaryConsoleOpen(const char* title,int maxLines,int mode,const int position[2],const int size[2],const float textColor[3],const float backgroundColor[3],const char* topic);
    std::vector<msgpack::object>* simxAuxiliaryConsoleShow(int consoleHandle,bool showState,const char* topic);

    std::vector<msgpack::object>* simxAddDrawingObject_points(int size,const int color[3],const float coords[3],int pointCnt,const char* topic);
    std::vector<msgpack::object>* simxAddDrawingObject_spheres(float size,const int color[3],const float coords[3],int sphereCnt,const char* topic);
    std::vector<msgpack::object>* simxAddDrawingObject_cubes(float size,const int color[3],const float coords[3],int cubeCnt,const char* topic);
    ...
    std::vector<msgpack::object>* simxSetFloatSignal(const char* sig,float val,const char* topic);
    std::vector<msgpack::object>* simxSetIntegerSignal(const char* sig,int val,const char* topic);
    std::vector<msgpack::object>* simxSetStringSignal(const char* sig,const char* val,size_t valSize,const char* topic);
    std::vector<msgpack::object>* simxGetFloatSignal(const char* sig,const char* topic);
    std::vector<msgpack::object>* simxGetIntegerSignal(const char* sig,const char* topic);
    std::vector<msgpack::object>* simxGetStringSignal(const char* sig,const char* topic);

    std::vector<msgpack::object>* simxSetObjectPosition(int objectHandle,int refObjectHandle,const float pos[3],const char* topic);
    std::vector<msgpack::object>* simxGetObjectOrientation(int objectHandle,int refObjectHandle,const char* topic);
    std::vector<msgpack::object>* simxSetObjectOrientation(int objectHandle,int refObjectHandle,const float euler[3],const char* topic);
    std::vector<msgpack::object>* simxGetObjectQuaternion(int objectHandle,int refObjectHandle,const char* topic);
    std::vector<msgpack::object>* simxSetObjectQuaternion(int objectHandle,int refObjectHandle,const float quat[4],const char* topic);
    std::vector<msgpack::object>* simxGetObjectPose(int objectHandle,int refObjectHandle,const char* topic);
    std::vector<msgpack::object>* simxSetObjectPose(int objectHandle,int refObjectHandle,const float pose[7],const char* topic);
    std::vector<msgpack::object>* simxGetObjectMatrix(int objectHandle,int refObjectHandle,const char* topic);
    std::vector<msgpack::object>* simxSetObjectMatrix(int objectHandle,int refObjectHandle,const float matr[12],const char* topic);
